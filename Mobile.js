...
class Mobile {
    constructor(option) {
        ...
        this.items = (options.menu && options.menu.length !== 0) ? options.menu : [
            {
                name: 'menu1',
        ...
        /*手机的背景图*/
        this.bg = options.bg || 'http://www.rui2.net/uploadfile/output/3/2013/1001/4acf64758d420524.jpg'
        this.ul = {} //菜单列表
        this.interval = undefined //刷新时间的定时器
        this.menuColor = options.menuColor || 'black' //菜单文字颜色
        this.searchInterval = undefined //搜索入口的特效定时器
        this.searchCallback = options.searchCallback || function (search) { console.log(search) } //点击搜索触发的操作
